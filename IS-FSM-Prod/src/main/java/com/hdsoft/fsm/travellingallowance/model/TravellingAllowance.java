package com.hdsoft.fsm.travellingallowance.model;
...
@Entity
@Table(name = "travellingallowance")
public class TravellingAllowance {
    ...
    public TravellingAllowance(){

    }

    public TravellingAllowance(long id, String dateOfData,String startLocation,String locationCovered,String startTripCount, String endTripCount, String allowanceReceived, String callBrands, String typeOfMachine, String modeOfConveyance){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TravellingAllowance)) return false;
        TravellingAllowance that = (TravellingAllowance) o;
