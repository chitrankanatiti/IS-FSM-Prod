...
public class ChipLevelRepairDTO {
    private long id;
    ...
    public ChipLevelRepairDTO(){

    }

    public ChipLevelRepairDTO(long id, long repairVoucherNo, String submitted,String returned, String repairStarters, String amount, String remarks){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChipLevelRepairDTO)) return false;
        ChipLevelRepairDTO that = (ChipLevelRepairDTO) o;
