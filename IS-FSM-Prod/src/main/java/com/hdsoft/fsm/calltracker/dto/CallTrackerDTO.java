...
public class CallTrackerDTO {
    ...
    public Engineer getServiceEngineer() {
        return serviceEngineer;
    }

    public void setServiceEngineer(Engineer serviceEngineer) {
        this.serviceEngineer = serviceEngineer;
    }
